...
class Metaclass_RobotMove_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('mobilebot_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'mobilebot_interfaces.action.RobotMove_Goal')
            logger.debug(
...
class RobotMove_Goal(metaclass=Metaclass_RobotMove_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.goalposition = kwargs.get('goalposition', int())
        self.goalvelocity = kwargs.get('goalvelocity', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.goalposition != other.goalposition:
            return False
        if self.goalvelocity != other.goalvelocity:
            return False
        return True
    ...
    def goalposition(self, value):
        if __debug__:
            assert \
                ...
                "The 'goalposition' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'goalposition' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._goalposition = value

    @builtins.property
    def goalvelocity(self):
        """Message field 'goalvelocity'."""
        return self._goalvelocity
    ...
    def goalvelocity(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'goalvelocity' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'goalvelocity' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._goalvelocity = value
...
class Metaclass_RobotMove_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mobilebot_interfaces.action.RobotMove_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_RobotMove_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mobilebot_interfaces.action.RobotMove_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_RobotMove_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mobilebot_interfaces.action import RobotMove
...
class RobotMove_SendGoal_Request(metaclass=Metaclass_RobotMove_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'mobilebot_interfaces/RobotMove_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['mobilebot_interfaces', 'action'], 'RobotMove_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from mobilebot_interfaces.action._robot_move import RobotMove_Goal
...
class Metaclass_RobotMove_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mobilebot_interfaces.action.RobotMove_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from mobilebot_interfaces.action import _robot_move
...
class RobotMove_SendGoal(metaclass=Metaclass_RobotMove_SendGoal):
    from mobilebot_interfaces.action._robot_move import RobotMove_SendGoal_Request as Request
    from mobilebot_interfaces.action._robot_move import RobotMove_SendGoal_Response as Response
...
class RobotMove_GetResult_Response(metaclass=Metaclass_RobotMove_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'mobilebot_interfaces/RobotMove_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['mobilebot_interfaces', 'action'], 'RobotMove_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from mobilebot_interfaces.action._robot_move import RobotMove_Result
...
class Metaclass_RobotMove_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mobilebot_interfaces.action.RobotMove_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RobotMove_GetResult(metaclass=Metaclass_RobotMove_GetResult):
    from mobilebot_interfaces.action._robot_move import RobotMove_GetResult_Request as Request
    from mobilebot_interfaces.action._robot_move import RobotMove_GetResult_Response as Response
...
class Metaclass_RobotMove_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mobilebot_interfaces.action.RobotMove_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RobotMove_FeedbackMessage(metaclass=Metaclass_RobotMove_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'mobilebot_interfaces/RobotMove_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['mobilebot_interfaces', 'action'], 'RobotMove_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from mobilebot_interfaces.action._robot_move import RobotMove_Feedback
...
class Metaclass_RobotMove(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mobilebot_interfaces.action.RobotMove')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RobotMove(metaclass=Metaclass_RobotMove):
    ...
    from mobilebot_interfaces.action._robot_move import RobotMove_Goal as Goal
    # The result message defined in the action definition.
    from mobilebot_interfaces.action._robot_move import RobotMove_Result as Result
    # The feedback message defined in the action definition.
    from mobilebot_interfaces.action._robot_move import RobotMove_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from mobilebot_interfaces.action._robot_move import RobotMove_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from mobilebot_interfaces.action._robot_move import RobotMove_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from mobilebot_interfaces.action._robot_move import RobotMove_FeedbackMessage as FeedbackMessage
