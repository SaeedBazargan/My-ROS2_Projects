...
{
  new (message_memory) mobilebot_interfaces::msg::Int64(_init);
}

void Int64_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mobilebot_interfaces::msg::Int64 *>(message_memory);
  typed_message->~Int64();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Int64_message_member_array[1] = {
  {
    ...
    offsetof(mobilebot_interfaces::msg::Int64, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Int64_message_members = {
  "mobilebot_interfaces::msg",  // message namespace
  "Int64",  // message name
  1,  // number of fields
  sizeof(mobilebot_interfaces::msg::Int64),
...
{
  return &::mobilebot_interfaces::msg::rosidl_typesupport_introspection_cpp::Int64_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mobilebot_interfaces, msg, Int64)() {
  return &::mobilebot_interfaces::msg::rosidl_typesupport_introspection_cpp::Int64_message_type_support_handle;
}
