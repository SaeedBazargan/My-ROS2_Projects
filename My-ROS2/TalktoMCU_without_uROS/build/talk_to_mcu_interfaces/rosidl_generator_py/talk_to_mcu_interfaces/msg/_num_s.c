...
bool talk_to_mcu_interfaces__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
...
PyObject * talk_to_mcu_interfaces__msg__num__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("talk_to_mcu_interfaces.msg._num");
