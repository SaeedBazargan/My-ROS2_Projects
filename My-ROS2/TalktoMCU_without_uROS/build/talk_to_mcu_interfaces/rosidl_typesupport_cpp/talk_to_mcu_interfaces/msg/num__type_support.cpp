...
static const _Num_type_support_symbol_names_t _Num_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, talk_to_mcu_interfaces, msg, Num)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, talk_to_mcu_interfaces, msg, Num)),
  }
};
...
get_message_type_support_handle<talk_to_mcu_interfaces::msg::Num>()
{
  return &::talk_to_mcu_interfaces::msg::rosidl_typesupport_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, talk_to_mcu_interfaces, msg, Num)() {
  return get_message_type_support_handle<talk_to_mcu_interfaces::msg::Num>();
}
