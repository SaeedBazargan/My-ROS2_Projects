...
{
  new (message_memory) talk_to_mcu_interfaces::msg::Num(_init);
}

void Num_fini_function(void * message_memory)
{
  auto typed_message = static_cast<talk_to_mcu_interfaces::msg::Num *>(message_memory);
  typed_message->~Num();
}
...
{
  return &::talk_to_mcu_interfaces::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, talk_to_mcu_interfaces, msg, Num)() {
  return &::talk_to_mcu_interfaces::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
